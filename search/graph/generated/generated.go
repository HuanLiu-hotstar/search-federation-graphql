...
type ComplexityRoot struct {
	...
	Query struct {
		Search             func(childComplexity int, w string) int
...
type QueryResolver interface {
	Search(ctx context.Context, w string) ([]*model.Content, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.search":
		...
		return e.complexity.Query.Search(childComplexity, args["w"].(string)), true
...
func (ec *executionContext) _Entity_findContentByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNContent2ᚖgithubᚗcomᚋHuanLiuᚑhotstarᚋsearchᚑfederationᚑgraphqlᚋsearchᚋgraphᚋmodelᚐContent(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_search(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Search(rctx, args["w"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*model.Content)
	fc.Result = res
	return ec.marshalOContent2ᚕᚖgithubᚗcomᚋHuanLiuᚑhotstarᚋsearchᚑfederationᚑgraphqlᚋsearchᚋgraphᚋmodelᚐContentᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNContent2githubᚗcomᚋHuanLiuᚑhotstarᚋsearchᚑfederationᚑgraphqlᚋsearchᚋgraphᚋmodelᚐContent(ctx context.Context, sel ast.SelectionSet, v model.Content) graphql.Marshaler {
	return ec._Content(ctx, sel, &v)
}

func (ec *executionContext) marshalNContent2ᚖgithubᚗcomᚋHuanLiuᚑhotstarᚋsearchᚑfederationᚑgraphqlᚋsearchᚋgraphᚋmodelᚐContent(ctx context.Context, sel ast.SelectionSet, v *model.Content) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOContent2ᚕᚖgithubᚗcomᚋHuanLiuᚑhotstarᚋsearchᚑfederationᚑgraphqlᚋsearchᚋgraphᚋmodelᚐContentᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Content) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNContent2ᚖgithubᚗcomᚋHuanLiuᚑhotstarᚋsearchᚑfederationᚑgraphqlᚋsearchᚋgraphᚋmodelᚐContent(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
